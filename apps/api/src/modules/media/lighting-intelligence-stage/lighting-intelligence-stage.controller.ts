...
@Controller('media/ultra-ecosystem/lighting-intelligence')
export class LightingIntelligenceStageController {
  constructor(
    private readonly service: LightingIntelligenceStageService,
  ) {}
