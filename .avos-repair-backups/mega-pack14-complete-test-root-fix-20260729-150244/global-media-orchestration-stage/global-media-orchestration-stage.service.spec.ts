...
describe('GlobalMediaOrchestrationStageService', () => {
  let service: GlobalMediaOrchestrationStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [GlobalMediaOrchestrationStageService] }).compile();
    service = module.get(GlobalMediaOrchestrationStageService);
  });
