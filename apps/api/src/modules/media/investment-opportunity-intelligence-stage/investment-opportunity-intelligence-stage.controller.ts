...
@Controller('media/business-revenue/investment-opportunity-intelligence')
export class InvestmentOpportunityIntelligenceStageController {
  constructor(private readonly service: InvestmentOpportunityIntelligenceStageService) {}
