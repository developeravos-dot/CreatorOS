...
describe('TrademarkManagementStageService', () => {
  let service: TrademarkManagementStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [TrademarkManagementStageService],
    }).compile();

    service = module.get<TrademarkManagementStageService>(TrademarkManagementStageService);
  });
