...
@Controller('media/creative-ecosystem/production-council')
export class ProductionCouncilStageController {
  constructor(private readonly service: ProductionCouncilStageService) {}
