...
describe('BusinessClientSolutionsStageService', () => {
  let service: BusinessClientSolutionsStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [BusinessClientSolutionsStageService] }).compile();
    service = module.get<BusinessClientSolutionsStageService>(BusinessClientSolutionsStageService);
  });
