...
@Controller('media/business-revenue/subscription-membership-intelligence')
export class SubscriptionMembershipIntelligenceStageController {
  constructor(private readonly service: SubscriptionMembershipIntelligenceStageService) {}
