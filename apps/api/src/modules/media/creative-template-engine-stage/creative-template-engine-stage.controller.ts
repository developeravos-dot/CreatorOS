...
@Controller('media/creative-ecosystem/creative-template-engine')
export class CreativeTemplateEngineStageController {
  constructor(private readonly service: CreativeTemplateEngineStageService) {}
