...
@Controller('media/localization-global-distribution')
export class LocalizationGlobalDistributionController {
  constructor(
    private readonly service: LocalizationGlobalDistributionService,
  ) {}
