...
@Controller('media/ultra-ecosystem/distribution-intelligence')
export class DistributionIntelligenceStageController {
  constructor(
    private readonly service: DistributionIntelligenceStageService,
  ) {}
