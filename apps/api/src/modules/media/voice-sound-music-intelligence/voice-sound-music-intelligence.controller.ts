...
@Controller('media/voice-sound-music-intelligence')
export class VoiceSoundMusicIntelligenceController {
  constructor(
    private readonly service: VoiceSoundMusicIntelligenceService,
  ) {}
