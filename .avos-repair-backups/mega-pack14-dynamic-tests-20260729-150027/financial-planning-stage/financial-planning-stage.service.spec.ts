...
describe('FinancialPlanningStageService', () => {
  let service: FinancialPlanningStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [FinancialPlanningStageService] }).compile();
    service = module.get<FinancialPlanningStageService>(FinancialPlanningStageService);
  });
