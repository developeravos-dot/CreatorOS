...
@Controller('media/creative-ecosystem/production-strategy')
export class ProductionStrategyStageController {
  constructor(private readonly service: ProductionStrategyStageService) {}
