...
describe('IpProductizationStageService', () => {
  let service: IpProductizationStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [IpProductizationStageService],
    }).compile();

    service = module.get<IpProductizationStageService>(IpProductizationStageService);
  });
