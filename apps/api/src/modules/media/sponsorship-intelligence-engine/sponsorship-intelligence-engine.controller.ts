...
@Controller('media/sponsorship-intelligence')
export class SponsorshipIntelligenceEngineController {
  constructor(
    private readonly service: SponsorshipIntelligenceEngineService,
  ) {}
