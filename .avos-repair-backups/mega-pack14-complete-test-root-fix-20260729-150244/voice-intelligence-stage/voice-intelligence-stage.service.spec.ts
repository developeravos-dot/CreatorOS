...
describe('VoiceIntelligenceStageService', () => {
  let service: VoiceIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [VoiceIntelligenceStageService] }).compile();
    service = module.get(VoiceIntelligenceStageService);
  });
