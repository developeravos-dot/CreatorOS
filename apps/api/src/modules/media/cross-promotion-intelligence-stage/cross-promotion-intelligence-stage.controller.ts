...
@Controller('media/creative-ecosystem/cross-promotion-intelligence')
export class CrossPromotionIntelligenceStageController {
  constructor(private readonly service: CrossPromotionIntelligenceStageService) {}
