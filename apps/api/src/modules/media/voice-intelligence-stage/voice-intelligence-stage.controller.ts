...
@Controller('media/creative-ecosystem/voice-intelligence')
export class VoiceIntelligenceStageController {
  constructor(private readonly service: VoiceIntelligenceStageService) {}
