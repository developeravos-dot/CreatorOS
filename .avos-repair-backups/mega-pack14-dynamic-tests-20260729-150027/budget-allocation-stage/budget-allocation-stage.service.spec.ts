...
describe('BudgetAllocationStageService', () => {
  let service: BudgetAllocationStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [BudgetAllocationStageService] }).compile();
    service = module.get<BudgetAllocationStageService>(BudgetAllocationStageService);
  });
