...
@Controller('media/creative-ecosystem/creative-learning')
export class CreativeLearningStageController {
  constructor(private readonly service: CreativeLearningStageService) {}
