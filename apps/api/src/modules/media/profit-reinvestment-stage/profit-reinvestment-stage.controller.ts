...
@Controller('media/business-revenue/profit-reinvestment')
export class ProfitReinvestmentStageController {
  constructor(private readonly service: ProfitReinvestmentStageService) {}
