...
describe('SoundDesignIntelligenceStageService', () => {
  let service: SoundDesignIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [SoundDesignIntelligenceStageService] }).compile();
    service = module.get(SoundDesignIntelligenceStageService);
  });
