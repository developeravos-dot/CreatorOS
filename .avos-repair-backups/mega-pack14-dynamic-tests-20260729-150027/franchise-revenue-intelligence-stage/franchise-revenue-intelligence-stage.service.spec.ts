...
describe('FranchiseRevenueIntelligenceStageService', () => {
  let service: FranchiseRevenueIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [FranchiseRevenueIntelligenceStageService] }).compile();
    service = module.get<FranchiseRevenueIntelligenceStageService>(FranchiseRevenueIntelligenceStageService);
  });
