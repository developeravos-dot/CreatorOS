...
@Controller('media/global-expansion/market-performance-intelligence')
export class MarketPerformanceIntelligenceStageController {
  constructor(
    private readonly service: MarketPerformanceIntelligenceStageService,
  ) {}
