...
@Controller('media/ultra-ecosystem/directing-intelligence')
export class DirectingIntelligenceStageController {
  constructor(
    private readonly service: DirectingIntelligenceStageService,
  ) {}
