...
describe('CreativeAnalyticsStageService', () => {
  let service: CreativeAnalyticsStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CreativeAnalyticsStageService] }).compile();
    service = module.get(CreativeAnalyticsStageService);
  });
