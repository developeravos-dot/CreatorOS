...
@Controller('media/business-revenue/marketplace-intelligence')
export class MarketplaceIntelligenceStageController {
  constructor(private readonly service: MarketplaceIntelligenceStageService) {}
