...
describe('FinancialValuationStageService', () => {
  let service: FinancialValuationStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [FinancialValuationStageService],
    }).compile();

    service = module.get<FinancialValuationStageService>(FinancialValuationStageService);
  });
