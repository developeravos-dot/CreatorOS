...
@Controller('media/business-revenue/conversion-optimization')
export class ConversionOptimizationStageController {
  constructor(private readonly service: ConversionOptimizationStageService) {}
