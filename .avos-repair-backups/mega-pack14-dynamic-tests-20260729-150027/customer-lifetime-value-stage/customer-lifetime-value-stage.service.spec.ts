...
describe('CustomerLifetimeValueStageService', () => {
  let service: CustomerLifetimeValueStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CustomerLifetimeValueStageService] }).compile();
    service = module.get<CustomerLifetimeValueStageService>(CustomerLifetimeValueStageService);
  });
