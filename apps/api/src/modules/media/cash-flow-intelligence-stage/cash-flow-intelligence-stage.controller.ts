...
@Controller('media/business-revenue/cash-flow-intelligence')
export class CashFlowIntelligenceStageController {
  constructor(private readonly service: CashFlowIntelligenceStageService) {}
