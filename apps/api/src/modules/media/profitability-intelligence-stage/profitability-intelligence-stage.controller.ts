...
@Controller('media/business-revenue/profitability-intelligence')
export class ProfitabilityIntelligenceStageController {
  constructor(private readonly service: ProfitabilityIntelligenceStageService) {}
