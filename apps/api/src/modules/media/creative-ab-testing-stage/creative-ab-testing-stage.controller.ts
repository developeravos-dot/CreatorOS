...
@Controller('media/ultra-ecosystem/creative-ab-testing')
export class CreativeAbTestingStageController {
  constructor(
    private readonly service: CreativeAbTestingStageService,
  ) {}
