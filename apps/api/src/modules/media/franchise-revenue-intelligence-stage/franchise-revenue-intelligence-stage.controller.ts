...
@Controller('media/business-revenue/franchise-revenue-intelligence')
export class FranchiseRevenueIntelligenceStageController {
  constructor(private readonly service: FranchiseRevenueIntelligenceStageService) {}
