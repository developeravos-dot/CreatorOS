...
@Controller('media/ip-empire/licensing-management')
export class LicensingManagementStageController {
  constructor(
    private readonly service: LicensingManagementStageService,
  ) {}
