...
@Controller('media/brand-identity-creative-studio')
export class BrandIdentityCreativeStudioController {
  constructor(
    private readonly service: BrandIdentityCreativeStudioService,
  ) {}
