...
describe('MarketDemandIntelligenceStageService', () => {
  let service: MarketDemandIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [MarketDemandIntelligenceStageService] }).compile();
    service = module.get<MarketDemandIntelligenceStageService>(MarketDemandIntelligenceStageService);
  });
