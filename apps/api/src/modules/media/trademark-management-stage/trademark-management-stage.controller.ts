...
@Controller('media/ip-empire/trademark-management')
export class TrademarkManagementStageController {
  constructor(
    private readonly service: TrademarkManagementStageService,
  ) {}
