...
describe('ProductionStrategyStageService', () => {
  let service: ProductionStrategyStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [ProductionStrategyStageService] }).compile();
    service = module.get(ProductionStrategyStageService);
  });
