...
@Controller('media/ip-empire/copyright-management')
export class CopyrightManagementStageController {
  constructor(
    private readonly service: CopyrightManagementStageService,
  ) {}
