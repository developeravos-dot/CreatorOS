...
describe('ProtectabilityAnalysisStageService', () => {
  let service: ProtectabilityAnalysisStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [ProtectabilityAnalysisStageService],
    }).compile();

    service = module.get<ProtectabilityAnalysisStageService>(ProtectabilityAnalysisStageService);
  });
