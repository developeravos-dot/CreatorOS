...
@Controller('media/creative-ecosystem/channel-network-intelligence')
export class ChannelNetworkIntelligenceStageController {
  constructor(private readonly service: ChannelNetworkIntelligenceStageService) {}
