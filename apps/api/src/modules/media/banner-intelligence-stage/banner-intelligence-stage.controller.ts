...
@Controller('media/creative-ecosystem/banner-intelligence')
export class BannerIntelligenceStageController {
  constructor(private readonly service: BannerIntelligenceStageService) {}
