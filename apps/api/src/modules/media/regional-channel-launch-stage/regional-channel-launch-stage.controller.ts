...
@Controller('media/global-expansion/regional-channel-launch')
export class RegionalChannelLaunchStageController {
  constructor(
    private readonly service: RegionalChannelLaunchStageService,
  ) {}
