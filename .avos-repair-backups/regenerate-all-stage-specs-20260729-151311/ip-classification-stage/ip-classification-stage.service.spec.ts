...
describe('IpClassificationStageService', () => {
  let service: IpClassificationStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [IpClassificationStageService],
    }).compile();

    service = module.get<IpClassificationStageService>(IpClassificationStageService);
  });
