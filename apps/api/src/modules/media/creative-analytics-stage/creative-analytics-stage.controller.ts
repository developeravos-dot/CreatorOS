...
@Controller('media/creative-ecosystem/creative-analytics')
export class CreativeAnalyticsStageController {
  constructor(private readonly service: CreativeAnalyticsStageService) {}
