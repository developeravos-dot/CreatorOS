...
@Controller('media/global-expansion/advertising-expansion')
export class AdvertisingExpansionStageController {
  constructor(
    private readonly service: AdvertisingExpansionStageService,
  ) {}
