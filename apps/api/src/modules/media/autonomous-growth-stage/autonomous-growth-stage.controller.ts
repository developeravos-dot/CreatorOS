...
@Controller('media/business-revenue/autonomous-growth')
export class AutonomousGrowthStageController {
  constructor(private readonly service: AutonomousGrowthStageService) {}
