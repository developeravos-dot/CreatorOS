...
describe('CrossPromotionIntelligenceStageService', () => {
  let service: CrossPromotionIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CrossPromotionIntelligenceStageService] }).compile();
    service = module.get(CrossPromotionIntelligenceStageService);
  });
