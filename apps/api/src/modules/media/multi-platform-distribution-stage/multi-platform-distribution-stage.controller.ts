...
@Controller('media/global-expansion/multi-platform-distribution')
export class MultiPlatformDistributionStageController {
  constructor(
    private readonly service: MultiPlatformDistributionStageService,
  ) {}
