...
@Controller('media/global-expansion/cultural-adaptation')
export class CulturalAdaptationStageController {
  constructor(
    private readonly service: CulturalAdaptationStageService,
  ) {}
