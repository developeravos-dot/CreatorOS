...
@Controller('media/creative-ecosystem/character-intelligence')
export class CharacterIntelligenceStageController {
  constructor(private readonly service: CharacterIntelligenceStageService) {}
