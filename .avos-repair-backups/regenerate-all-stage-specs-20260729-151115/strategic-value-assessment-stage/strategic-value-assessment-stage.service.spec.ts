...
describe('StrategicValueAssessmentStageService', () => {
  let service: StrategicValueAssessmentStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [StrategicValueAssessmentStageService],
    }).compile();

    service = module.get<StrategicValueAssessmentStageService>(StrategicValueAssessmentStageService);
  });
