...
describe('ContentInvestmentEngineStageService', () => {
  let service: ContentInvestmentEngineStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [ContentInvestmentEngineStageService] }).compile();
    service = module.get<ContentInvestmentEngineStageService>(ContentInvestmentEngineStageService);
  });
