...
describe('IpAssetDiscoveryStageService', () => {
  let service: IpAssetDiscoveryStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [IpAssetDiscoveryStageService],
    }).compile();

    service = module.get<IpAssetDiscoveryStageService>(IpAssetDiscoveryStageService);
  });
