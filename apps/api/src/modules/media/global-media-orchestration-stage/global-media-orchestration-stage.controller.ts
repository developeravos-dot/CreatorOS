...
@Controller('media/creative-ecosystem/global-media-orchestration')
export class GlobalMediaOrchestrationStageController {
  constructor(private readonly service: GlobalMediaOrchestrationStageService) {}
