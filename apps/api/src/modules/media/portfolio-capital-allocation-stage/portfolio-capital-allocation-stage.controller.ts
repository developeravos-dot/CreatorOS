...
@Controller('media/business-revenue/portfolio-capital-allocation')
export class PortfolioCapitalAllocationStageController {
  constructor(private readonly service: PortfolioCapitalAllocationStageService) {}
