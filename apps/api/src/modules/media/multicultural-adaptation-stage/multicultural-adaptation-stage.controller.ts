...
@Controller('media/creative-ecosystem/multicultural-adaptation')
export class MulticulturalAdaptationStageController {
  constructor(private readonly service: MulticulturalAdaptationStageService) {}
