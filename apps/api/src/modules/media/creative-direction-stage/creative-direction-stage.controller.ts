...
@Controller('media/creative-ecosystem/creative-direction')
export class CreativeDirectionStageController {
  constructor(private readonly service: CreativeDirectionStageService) {}
