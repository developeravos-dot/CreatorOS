...
describe('OfferArchitectureStageService', () => {
  let service: OfferArchitectureStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [OfferArchitectureStageService] }).compile();
    service = module.get<OfferArchitectureStageService>(OfferArchitectureStageService);
  });
