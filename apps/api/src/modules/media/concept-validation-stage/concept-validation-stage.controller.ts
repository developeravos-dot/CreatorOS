...
@Controller('media/ultra-ecosystem/concept-validation')
export class ConceptValidationStageController {
  constructor(
    private readonly service: ConceptValidationStageService,
  ) {}
