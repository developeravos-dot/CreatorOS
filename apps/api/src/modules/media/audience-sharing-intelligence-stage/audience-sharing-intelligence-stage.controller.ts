...
@Controller('media/creative-ecosystem/audience-sharing-intelligence')
export class AudienceSharingIntelligenceStageController {
  constructor(private readonly service: AudienceSharingIntelligenceStageService) {}
