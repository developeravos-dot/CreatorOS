...
describe('LicensingManagementStageService', () => {
  let service: LicensingManagementStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [LicensingManagementStageService],
    }).compile();

    service = module.get<LicensingManagementStageService>(LicensingManagementStageService);
  });
