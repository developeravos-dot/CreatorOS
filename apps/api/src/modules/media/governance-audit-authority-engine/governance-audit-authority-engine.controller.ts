...
@Controller('media/governance-audit-authority')
export class GovernanceAuditAuthorityEngineController {
  constructor(
    private readonly service: GovernanceAuditAuthorityEngineService,
  ) {}
