...
@Controller('media/creative-ecosystem/visual-style-intelligence')
export class VisualStyleIntelligenceStageController {
  constructor(private readonly service: VisualStyleIntelligenceStageService) {}
