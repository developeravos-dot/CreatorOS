...
describe('OriginalitySimilarityAnalysisStageService', () => {
  let service: OriginalitySimilarityAnalysisStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [OriginalitySimilarityAnalysisStageService],
    }).compile();

    service = module.get<OriginalitySimilarityAnalysisStageService>(OriginalitySimilarityAnalysisStageService);
  });
