...
@Controller('media/storyboard-shot-intelligence')
export class StoryboardShotIntelligenceController {
  constructor(
    private readonly service: StoryboardShotIntelligenceService,
  ) {}
