...
@Controller('media/ultra-ecosystem/continuity-control')
export class ContinuityControlStageController {
  constructor(
    private readonly service: ContinuityControlStageService,
  ) {}
