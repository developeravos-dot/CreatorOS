...
@Controller('media/ultra-ecosystem/creative-quality-assurance')
export class CreativeQualityAssuranceStageController {
  constructor(
    private readonly service: CreativeQualityAssuranceStageService,
  ) {}
