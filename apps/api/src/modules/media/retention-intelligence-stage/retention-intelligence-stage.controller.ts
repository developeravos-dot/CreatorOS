...
@Controller('media/ultra-ecosystem/retention-intelligence')
export class RetentionIntelligenceStageController {
  constructor(
    private readonly service: RetentionIntelligenceStageService,
  ) {}
