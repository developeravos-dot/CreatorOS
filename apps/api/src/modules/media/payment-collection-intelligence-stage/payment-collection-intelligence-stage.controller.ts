...
@Controller('media/business-revenue/payment-collection-intelligence')
export class PaymentCollectionIntelligenceStageController {
  constructor(private readonly service: PaymentCollectionIntelligenceStageService) {}
