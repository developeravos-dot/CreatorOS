...
@Controller('media/creative-production-intelligence')
export class CreativeProductionIntelligenceController {
  constructor(
    private readonly service: CreativeProductionIntelligenceService,
  ) {}
