...
@Controller('media/business-revenue/royalty-accounting')
export class RoyaltyAccountingStageController {
  constructor(private readonly service: RoyaltyAccountingStageService) {}
