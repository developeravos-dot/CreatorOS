...
@Controller('media/agent-team-orchestration')
export class AgentTeamOrchestrationEngineController {
  constructor(
    private readonly service: AgentTeamOrchestrationEngineService,
  ) {}
