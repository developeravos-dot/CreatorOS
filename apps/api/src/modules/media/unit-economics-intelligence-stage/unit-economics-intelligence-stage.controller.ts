...
@Controller('media/business-revenue/unit-economics-intelligence')
export class UnitEconomicsIntelligenceStageController {
  constructor(private readonly service: UnitEconomicsIntelligenceStageService) {}
