...
describe('ProfitabilityIntelligenceStageService', () => {
  let service: ProfitabilityIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [ProfitabilityIntelligenceStageService] }).compile();
    service = module.get<ProfitabilityIntelligenceStageService>(ProfitabilityIntelligenceStageService);
  });
