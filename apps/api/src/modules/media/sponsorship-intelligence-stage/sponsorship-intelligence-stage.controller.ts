...
@Controller('media/ultra-ecosystem/sponsorship-intelligence')
export class SponsorshipIntelligenceStageController {
  constructor(
    private readonly service: SponsorshipIntelligenceStageService,
  ) {}
