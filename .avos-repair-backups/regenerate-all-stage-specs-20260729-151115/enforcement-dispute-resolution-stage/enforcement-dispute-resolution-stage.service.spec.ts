...
describe('EnforcementDisputeResolutionStageService', () => {
  let service: EnforcementDisputeResolutionStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [EnforcementDisputeResolutionStageService],
    }).compile();

    service = module.get<EnforcementDisputeResolutionStageService>(EnforcementDisputeResolutionStageService);
  });
