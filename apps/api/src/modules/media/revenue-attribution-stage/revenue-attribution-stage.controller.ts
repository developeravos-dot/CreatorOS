...
@Controller('media/ultra-ecosystem/revenue-attribution')
export class RevenueAttributionStageController {
  constructor(
    private readonly service: RevenueAttributionStageService,
  ) {}
