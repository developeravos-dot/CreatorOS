...
@Controller('media/ultra-ecosystem/portfolio-optimization')
export class PortfolioOptimizationStageController {
  constructor(
    private readonly service: PortfolioOptimizationStageService,
  ) {}
