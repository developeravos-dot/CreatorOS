...
@Controller('media/ultra-ecosystem/platform-adaptation')
export class PlatformAdaptationStageController {
  constructor(
    private readonly service: PlatformAdaptationStageService,
  ) {}
