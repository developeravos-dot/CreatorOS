...
describe('EvidenceTimestampRegistrationStageService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [EvidenceTimestampRegistrationStageService],
    }).compile();

    service = module.get<EvidenceTimestampRegistrationStageService>(EvidenceTimestampRegistrationStageService);
  });
