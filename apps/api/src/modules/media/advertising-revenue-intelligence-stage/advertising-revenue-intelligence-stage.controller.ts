...
@Controller('media/business-revenue/advertising-revenue-intelligence')
export class AdvertisingRevenueIntelligenceStageController {
  constructor(private readonly service: AdvertisingRevenueIntelligenceStageService) {}
