...
@Controller('media/ultra-ecosystem/content-opportunity-detection')
export class ContentOpportunityDetectionStageController {
  constructor(
    private readonly service: ContentOpportunityDetectionStageService,
  ) {}
