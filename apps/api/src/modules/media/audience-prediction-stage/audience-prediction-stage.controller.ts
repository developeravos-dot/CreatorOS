...
@Controller('media/ultra-ecosystem/audience-prediction')
export class AudiencePredictionStageController {
  constructor(
    private readonly service: AudiencePredictionStageService,
  ) {}
