...
describe('PortfolioCapitalAllocationStageService', () => {
  let service: PortfolioCapitalAllocationStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [PortfolioCapitalAllocationStageService] }).compile();
    service = module.get<PortfolioCapitalAllocationStageService>(PortfolioCapitalAllocationStageService);
  });
