...
@Controller('media/workflow-orchestration')
export class MediaWorkflowOrchestrationEngineController {
  constructor(
    private readonly service: MediaWorkflowOrchestrationEngineService,
  ) {}
