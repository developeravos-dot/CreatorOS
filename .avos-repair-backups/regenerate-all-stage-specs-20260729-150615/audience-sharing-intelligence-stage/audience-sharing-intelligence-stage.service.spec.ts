...
describe('AudienceSharingIntelligenceStageService', () => {
  let service: AudienceSharingIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [AudienceSharingIntelligenceStageService] }).compile();
    service = module.get(AudienceSharingIntelligenceStageService);
  });
