...
@Controller('media/lifecycle/opportunity-discovery')
export class OpportunityDiscoveryStageController {
  constructor(
    private readonly service: OpportunityDiscoveryStageService,
  ) {}
