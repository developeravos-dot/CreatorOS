...
@Controller('media/global-expansion/expansion-readiness')
export class ExpansionReadinessStageController {
  constructor(
    private readonly service: ExpansionReadinessStageService,
  ) {}
