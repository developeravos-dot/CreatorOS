...
@Controller('media/business-revenue/audience-economic-intelligence')
export class AudienceEconomicIntelligenceStageController {
  constructor(private readonly service: AudienceEconomicIntelligenceStageService) {}
