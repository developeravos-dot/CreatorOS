...
@Controller('media/ultra-ecosystem/character-development')
export class CharacterDevelopmentStageController {
  constructor(
    private readonly service: CharacterDevelopmentStageService,
  ) {}
