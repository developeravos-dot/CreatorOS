...
describe('RightsOwnershipManagementStageService', () => {
  let service: RightsOwnershipManagementStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [RightsOwnershipManagementStageService],
    }).compile();

    service = module.get<RightsOwnershipManagementStageService>(RightsOwnershipManagementStageService);
  });
