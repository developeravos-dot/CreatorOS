...
@Controller('media/creative-ecosystem/multiplatform-adaptation')
export class MultiplatformAdaptationStageController {
  constructor(private readonly service: MultiplatformAdaptationStageService) {}
