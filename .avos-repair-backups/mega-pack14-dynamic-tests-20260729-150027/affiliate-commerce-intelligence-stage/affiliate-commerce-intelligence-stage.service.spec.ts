...
describe('AffiliateCommerceIntelligenceStageService', () => {
  let service: AffiliateCommerceIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [AffiliateCommerceIntelligenceStageService] }).compile();
    service = module.get<AffiliateCommerceIntelligenceStageService>(AffiliateCommerceIntelligenceStageService);
  });
