...
@Controller('media/audience-cultural-intelligence')
export class AudienceCulturalIntelligenceController {
  constructor(
    private readonly service: AudienceCulturalIntelligenceService,
  ) {}
