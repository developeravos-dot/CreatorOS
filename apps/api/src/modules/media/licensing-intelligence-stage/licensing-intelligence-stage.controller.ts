...
@Controller('media/ultra-ecosystem/licensing-intelligence')
export class LicensingIntelligenceStageController {
  constructor(
    private readonly service: LicensingIntelligenceStageService,
  ) {}
