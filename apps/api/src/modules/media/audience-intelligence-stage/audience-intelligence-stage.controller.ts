...
@Controller('media/creative-ecosystem/audience-intelligence')
export class AudienceIntelligenceStageController {
  constructor(private readonly service: AudienceIntelligenceStageService) {}
