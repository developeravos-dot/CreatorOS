...
@Controller('media/ip-empire/strategic-value-assessment')
export class StrategicValueAssessmentStageController {
  constructor(
    private readonly service: StrategicValueAssessmentStageService,
  ) {}
