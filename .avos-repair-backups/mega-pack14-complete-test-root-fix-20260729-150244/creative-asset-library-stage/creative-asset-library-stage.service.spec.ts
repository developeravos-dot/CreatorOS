...
describe('CreativeAssetLibraryStageService', () => {
  let service: CreativeAssetLibraryStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CreativeAssetLibraryStageService] }).compile();
    service = module.get(CreativeAssetLibraryStageService);
  });
