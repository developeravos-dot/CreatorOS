...
@Controller('media/publishing-orchestration')
export class PublishingOrchestrationEngineController {
  constructor(
    private readonly service: PublishingOrchestrationEngineService,
  ) {}
