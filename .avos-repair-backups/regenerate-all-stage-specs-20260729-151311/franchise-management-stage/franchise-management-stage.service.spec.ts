...
describe('FranchiseManagementStageService', () => {
  let service: FranchiseManagementStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [FranchiseManagementStageService],
    }).compile();

    service = module.get<FranchiseManagementStageService>(FranchiseManagementStageService);
  });
