...
@Controller('media/business-revenue/premium-content-intelligence')
export class PremiumContentIntelligenceStageController {
  constructor(private readonly service: PremiumContentIntelligenceStageService) {}
