...
describe('RevenueStreamDesignStageService', () => {
  let service: RevenueStreamDesignStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [RevenueStreamDesignStageService] }).compile();
    service = module.get<RevenueStreamDesignStageService>(RevenueStreamDesignStageService);
  });
