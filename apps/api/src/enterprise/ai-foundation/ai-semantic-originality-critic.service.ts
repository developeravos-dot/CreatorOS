  ...
  async review(
    ...
    if (!extraction.success) {
      return {
        ...
        confidence: 100,
        reasons: [
          'فشل محرك البصمة الدلالية في استخراج JSON صالح بعد جميع محاولات الإصلاح.',
        ],
        warnings: extraction.errors,
        recommendations: [
          'تحقق من تشغيل Ollama والنموذج المحلي، ثم أعد تنفيذ الطلب.',
        ],
        metadata: {
          engine:
