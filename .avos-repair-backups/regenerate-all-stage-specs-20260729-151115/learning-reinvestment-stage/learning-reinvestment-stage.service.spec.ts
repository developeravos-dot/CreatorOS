...
describe('LearningReinvestmentStageService', () => {
  let service: LearningReinvestmentStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [LearningReinvestmentStageService],
    }).compile();

    service = module.get<LearningReinvestmentStageService>(LearningReinvestmentStageService);
  });
