...
@Controller('media/business-revenue/offer-architecture')
export class OfferArchitectureStageController {
  constructor(private readonly service: OfferArchitectureStageService) {}
