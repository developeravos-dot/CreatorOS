...
@Controller('media/ultra-ecosystem/script-intelligence')
export class ScriptIntelligenceStageController {
  constructor(
    private readonly service: ScriptIntelligenceStageService,
  ) {}
