...
describe('CharacterIntelligenceStageService', () => {
  let service: CharacterIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CharacterIntelligenceStageService] }).compile();
    service = module.get(CharacterIntelligenceStageService);
  });
