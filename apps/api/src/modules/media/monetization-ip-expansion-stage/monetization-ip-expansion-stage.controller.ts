...
@Controller('media/lifecycle/monetization-ip-expansion')
export class MonetizationIpExpansionStageController {
  constructor(
    private readonly service: MonetizationIpExpansionStageService,
  ) {}
