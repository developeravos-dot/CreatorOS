...
@Controller('media/ip-empire/market-opportunity-analysis')
export class MarketOpportunityAnalysisStageController {
  constructor(
    private readonly service: MarketOpportunityAnalysisStageService,
  ) {}
