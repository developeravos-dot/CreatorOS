...
@Controller('media/ultra-ecosystem/performance-analytics')
export class PerformanceAnalyticsStageController {
  constructor(
    private readonly service: PerformanceAnalyticsStageService,
  ) {}
