...
@Controller('media/ultra-ecosystem/commerce-intelligence')
export class CommerceIntelligenceStageController {
  constructor(
    private readonly service: CommerceIntelligenceStageService,
  ) {}
