...
@Controller('media/ip-empire/rights-ownership-management')
export class RightsOwnershipManagementStageController {
  constructor(
    private readonly service: RightsOwnershipManagementStageService,
  ) {}
