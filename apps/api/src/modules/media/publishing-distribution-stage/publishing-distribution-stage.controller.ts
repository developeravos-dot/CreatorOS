...
@Controller('media/lifecycle/publishing-distribution')
export class PublishingDistributionStageController {
  constructor(
    private readonly service: PublishingDistributionStageService,
  ) {}
