...
describe('ProtectableIdeaExtractionStageService', () => {
  let service: ProtectableIdeaExtractionStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [ProtectableIdeaExtractionStageService],
    }).compile();

    service = module.get<ProtectableIdeaExtractionStageService>(ProtectableIdeaExtractionStageService);
  });
