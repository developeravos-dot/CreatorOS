...
@Controller('media/script-screenplay-intelligence')
export class ScriptScreenplayIntelligenceController {
  constructor(
    private readonly service: ScriptScreenplayIntelligenceService,
  ) {}
