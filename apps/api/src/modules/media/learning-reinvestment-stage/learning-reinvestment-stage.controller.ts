...
@Controller('media/ip-empire/learning-reinvestment')
export class LearningReinvestmentStageController {
  constructor(
    private readonly service: LearningReinvestmentStageService,
  ) {}
