...
@Controller('media/business-revenue/budget-allocation')
export class BudgetAllocationStageController {
  constructor(private readonly service: BudgetAllocationStageService) {}
