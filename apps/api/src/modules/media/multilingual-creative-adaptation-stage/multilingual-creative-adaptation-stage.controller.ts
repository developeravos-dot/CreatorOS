...
@Controller('media/creative-ecosystem/multilingual-creative-adaptation')
export class MultilingualCreativeAdaptationStageController {
  constructor(private readonly service: MultilingualCreativeAdaptationStageService) {}
