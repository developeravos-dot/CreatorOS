...
describe('ProtectionStrategyStageService', () => {
  let service: ProtectionStrategyStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [ProtectionStrategyStageService],
    }).compile();

    service = module.get<ProtectionStrategyStageService>(ProtectionStrategyStageService);
  });
