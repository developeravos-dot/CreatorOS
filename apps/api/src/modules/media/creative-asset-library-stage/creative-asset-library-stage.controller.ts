...
@Controller('media/creative-ecosystem/creative-asset-library')
export class CreativeAssetLibraryStageController {
  constructor(private readonly service: CreativeAssetLibraryStageService) {}
