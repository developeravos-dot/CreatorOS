...
@Controller('media/business-revenue/financial-planning')
export class FinancialPlanningStageController {
  constructor(private readonly service: FinancialPlanningStageService) {}
