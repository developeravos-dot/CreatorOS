...
@Controller('media/ultra-ecosystem/human-final-authority')
export class HumanFinalAuthorityStageController {
  constructor(
    private readonly service: HumanFinalAuthorityStageService,
  ) {}
