...
describe('DigitalProductIntelligenceStageService', () => {
  let service: DigitalProductIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [DigitalProductIntelligenceStageService] }).compile();
    service = module.get<DigitalProductIntelligenceStageService>(DigitalProductIntelligenceStageService);
  });
