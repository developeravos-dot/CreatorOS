...
describe('CreatorServiceBusinessStageService', () => {
  let service: CreatorServiceBusinessStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CreatorServiceBusinessStageService] }).compile();
    service = module.get<CreatorServiceBusinessStageService>(CreatorServiceBusinessStageService);
  });
