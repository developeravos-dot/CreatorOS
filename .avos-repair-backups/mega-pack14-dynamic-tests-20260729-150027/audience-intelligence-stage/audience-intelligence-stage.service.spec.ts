...
describe('AudienceIntelligenceStageService', () => {
  let service: AudienceIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [AudienceIntelligenceStageService] }).compile();
    service = module.get(AudienceIntelligenceStageService);
  });
