...
@Controller('media/global-expansion/global-risk-governance')
export class GlobalRiskGovernanceStageController {
  constructor(
    private readonly service: GlobalRiskGovernanceStageService,
  ) {}
