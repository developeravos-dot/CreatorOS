...
@Controller('media/executive-decision-intelligence')
export class ExecutiveDecisionIntelligenceEngineController {
  constructor(
    private readonly service: ExecutiveDecisionIntelligenceEngineService,
  ) {}
