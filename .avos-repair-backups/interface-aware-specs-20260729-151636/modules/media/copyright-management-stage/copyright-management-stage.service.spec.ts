...
describe('CopyrightManagementStageService', () => {
  let service: CopyrightManagementStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [CopyrightManagementStageService],
    }).compile();

    service = module.get<CopyrightManagementStageService>(CopyrightManagementStageService);
  });
