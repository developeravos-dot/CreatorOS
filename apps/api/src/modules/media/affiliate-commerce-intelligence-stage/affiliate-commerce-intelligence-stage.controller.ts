...
@Controller('media/business-revenue/affiliate-commerce-intelligence')
export class AffiliateCommerceIntelligenceStageController {
  constructor(private readonly service: AffiliateCommerceIntelligenceStageService) {}
