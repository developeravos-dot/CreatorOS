...
@Controller('media/ultra-ecosystem/audience-segmentation')
export class AudienceSegmentationStageController {
  constructor(
    private readonly service: AudienceSegmentationStageService,
  ) {}
