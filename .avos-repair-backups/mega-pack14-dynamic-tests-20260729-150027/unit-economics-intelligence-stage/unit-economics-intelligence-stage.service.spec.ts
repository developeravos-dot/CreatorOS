...
describe('UnitEconomicsIntelligenceStageService', () => {
  let service: UnitEconomicsIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [UnitEconomicsIntelligenceStageService] }).compile();
    service = module.get<UnitEconomicsIntelligenceStageService>(UnitEconomicsIntelligenceStageService);
  });
