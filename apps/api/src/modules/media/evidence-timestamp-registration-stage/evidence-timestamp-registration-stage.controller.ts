...
@Controller('media/ip-empire/evidence-timestamp-registration')
export class EvidenceTimestampRegistrationStageController {
  constructor(
    private readonly service: EvidenceTimestampRegistrationStageService,
  ) {}
