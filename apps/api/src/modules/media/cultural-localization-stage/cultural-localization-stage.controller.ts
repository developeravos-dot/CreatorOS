...
@Controller('media/ultra-ecosystem/cultural-localization')
export class CulturalLocalizationStageController {
  constructor(
    private readonly service: CulturalLocalizationStageService,
  ) {}
