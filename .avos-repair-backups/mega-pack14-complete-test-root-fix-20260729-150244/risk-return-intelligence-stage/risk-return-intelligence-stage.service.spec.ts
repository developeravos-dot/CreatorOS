...
describe('RiskReturnIntelligenceStageService', () => {
  let service: RiskReturnIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [RiskReturnIntelligenceStageService] }).compile();
    service = module.get<RiskReturnIntelligenceStageService>(RiskReturnIntelligenceStageService);
  });
