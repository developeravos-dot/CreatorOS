...
describe('MultiplatformAdaptationStageService', () => {
  let service: MultiplatformAdaptationStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [MultiplatformAdaptationStageService] }).compile();
    service = module.get(MultiplatformAdaptationStageService);
  });
