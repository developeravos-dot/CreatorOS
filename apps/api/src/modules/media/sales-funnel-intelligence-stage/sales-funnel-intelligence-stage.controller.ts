...
@Controller('media/business-revenue/sales-funnel-intelligence')
export class SalesFunnelIntelligenceStageController {
  constructor(private readonly service: SalesFunnelIntelligenceStageService) {}
