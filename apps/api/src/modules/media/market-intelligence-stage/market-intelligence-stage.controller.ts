...
@Controller('media/ultra-ecosystem/market-intelligence')
export class MarketIntelligenceStageController {
  constructor(
    private readonly service: MarketIntelligenceStageService,
  ) {}
