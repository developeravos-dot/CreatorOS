...
@Controller('media/ip-empire/franchise-management')
export class FranchiseManagementStageController {
  constructor(
    private readonly service: FranchiseManagementStageService,
  ) {}
