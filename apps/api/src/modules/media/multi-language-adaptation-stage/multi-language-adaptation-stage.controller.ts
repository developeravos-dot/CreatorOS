...
@Controller('media/ultra-ecosystem/multi-language-adaptation')
export class MultiLanguageAdaptationStageController {
  constructor(
    private readonly service: MultiLanguageAdaptationStageService,
  ) {}
