...
@Controller('media/ultra-ecosystem/virtual-production')
export class VirtualProductionStageController {
  constructor(
    private readonly service: VirtualProductionStageService,
  ) {}
