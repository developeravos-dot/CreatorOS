...
describe('ProfitReinvestmentStageService', () => {
  let service: ProfitReinvestmentStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [ProfitReinvestmentStageService] }).compile();
    service = module.get<ProfitReinvestmentStageService>(ProfitReinvestmentStageService);
  });
