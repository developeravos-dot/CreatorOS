...
describe('MarketPerformanceIntelligenceStageService', () => {
  let service: MarketPerformanceIntelligenceStageService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<MarketPerformanceIntelligenceStageService>(MarketPerformanceIntelligenceStageService);
  });
