...
@Controller('media/global-expansion/local-audience-intelligence')
export class LocalAudienceIntelligenceStageController {
  constructor(
    private readonly service: LocalAudienceIntelligenceStageService,
  ) {}
