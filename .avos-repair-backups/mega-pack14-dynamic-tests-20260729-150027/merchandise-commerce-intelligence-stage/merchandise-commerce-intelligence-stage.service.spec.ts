...
describe('MerchandiseCommerceIntelligenceStageService', () => {
  let service: MerchandiseCommerceIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [MerchandiseCommerceIntelligenceStageService] }).compile();
    service = module.get<MerchandiseCommerceIntelligenceStageService>(MerchandiseCommerceIntelligenceStageService);
  });
