...
@Controller('media/creative-ecosystem/model-routing')
export class ModelRoutingStageController {
  constructor(private readonly service: ModelRoutingStageService) {}
