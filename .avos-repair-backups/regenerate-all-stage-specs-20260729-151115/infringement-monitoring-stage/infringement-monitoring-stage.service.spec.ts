...
describe('InfringementMonitoringStageService', () => {
  let service: InfringementMonitoringStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [InfringementMonitoringStageService],
    }).compile();

    service = module.get<InfringementMonitoringStageService>(InfringementMonitoringStageService);
  });
