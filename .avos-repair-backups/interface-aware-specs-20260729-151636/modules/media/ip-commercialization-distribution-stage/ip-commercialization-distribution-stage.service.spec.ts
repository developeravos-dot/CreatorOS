...
describe('IpCommercializationDistributionStageService', () => {
  let service: IpCommercializationDistributionStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [IpCommercializationDistributionStageService],
    }).compile();

    service = module.get<IpCommercializationDistributionStageService>(IpCommercializationDistributionStageService);
  });
