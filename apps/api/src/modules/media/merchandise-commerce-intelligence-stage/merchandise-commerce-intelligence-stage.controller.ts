...
@Controller('media/business-revenue/merchandise-commerce-intelligence')
export class MerchandiseCommerceIntelligenceStageController {
  constructor(private readonly service: MerchandiseCommerceIntelligenceStageService) {}
