...
describe('PremiumContentIntelligenceStageService', () => {
  let service: PremiumContentIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [PremiumContentIntelligenceStageService] }).compile();
    service = module.get<PremiumContentIntelligenceStageService>(PremiumContentIntelligenceStageService);
  });
