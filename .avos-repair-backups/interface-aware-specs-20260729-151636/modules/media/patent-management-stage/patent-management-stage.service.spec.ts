...
describe('PatentManagementStageService', () => {
  let service: PatentManagementStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [PatentManagementStageService],
    }).compile();

    service = module.get<PatentManagementStageService>(PatentManagementStageService);
  });
