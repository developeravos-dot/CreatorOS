...
describe('AdvertisingRevenueIntelligenceStageService', () => {
  let service: AdvertisingRevenueIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [AdvertisingRevenueIntelligenceStageService] }).compile();
    service = module.get<AdvertisingRevenueIntelligenceStageService>(AdvertisingRevenueIntelligenceStageService);
  });
