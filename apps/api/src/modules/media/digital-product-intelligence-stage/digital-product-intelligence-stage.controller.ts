...
@Controller('media/business-revenue/digital-product-intelligence')
export class DigitalProductIntelligenceStageController {
  constructor(private readonly service: DigitalProductIntelligenceStageService) {}
