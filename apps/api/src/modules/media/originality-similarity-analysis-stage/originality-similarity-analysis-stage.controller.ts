...
@Controller('media/ip-empire/originality-similarity-analysis')
export class OriginalitySimilarityAnalysisStageController {
  constructor(
    private readonly service: OriginalitySimilarityAnalysisStageService,
  ) {}
