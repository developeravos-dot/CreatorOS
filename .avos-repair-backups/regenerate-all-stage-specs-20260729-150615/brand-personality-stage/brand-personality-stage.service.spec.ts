...
describe('BrandPersonalityStageService', () => {
  let service: BrandPersonalityStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [BrandPersonalityStageService] }).compile();
    service = module.get(BrandPersonalityStageService);
  });
