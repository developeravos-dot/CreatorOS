...
@Controller('media/business-revenue/market-demand-intelligence')
export class MarketDemandIntelligenceStageController {
  constructor(private readonly service: MarketDemandIntelligenceStageService) {}
