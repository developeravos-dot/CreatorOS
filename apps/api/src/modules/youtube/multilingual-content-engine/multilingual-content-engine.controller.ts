...
@Controller('youtube/multilingual-content-engine')
export class MultilingualContentEngineController {
  constructor(
    private readonly service: MultilingualContentEngineService,
  ) {}
