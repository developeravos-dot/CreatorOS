...
@Controller('media/ultra-ecosystem/ecosystem-orchestration')
export class EcosystemOrchestrationStageController {
  constructor(
    private readonly service: EcosystemOrchestrationStageService,
  ) {}
