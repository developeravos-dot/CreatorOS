...
describe('BusinessModelIntelligenceStageService', () => {
  let service: BusinessModelIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [BusinessModelIntelligenceStageService] }).compile();
    service = module.get<BusinessModelIntelligenceStageService>(BusinessModelIntelligenceStageService);
  });
