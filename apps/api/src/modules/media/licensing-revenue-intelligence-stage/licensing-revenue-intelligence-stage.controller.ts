...
@Controller('media/business-revenue/licensing-revenue-intelligence')
export class LicensingRevenueIntelligenceStageController {
  constructor(private readonly service: LicensingRevenueIntelligenceStageService) {}
