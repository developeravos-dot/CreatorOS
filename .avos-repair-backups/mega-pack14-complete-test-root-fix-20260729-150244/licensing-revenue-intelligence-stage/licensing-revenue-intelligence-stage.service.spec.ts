...
describe('LicensingRevenueIntelligenceStageService', () => {
  let service: LicensingRevenueIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [LicensingRevenueIntelligenceStageService] }).compile();
    service = module.get<LicensingRevenueIntelligenceStageService>(LicensingRevenueIntelligenceStageService);
  });
