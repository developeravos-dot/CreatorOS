...
describe('BusinessHumanFinalAuthorityStageService', () => {
  let service: BusinessHumanFinalAuthorityStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [BusinessHumanFinalAuthorityStageService] }).compile();
    service = module.get<BusinessHumanFinalAuthorityStageService>(BusinessHumanFinalAuthorityStageService);
  });
