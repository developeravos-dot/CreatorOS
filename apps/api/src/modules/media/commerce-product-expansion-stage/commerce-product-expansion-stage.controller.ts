...
@Controller('media/global-expansion/commerce-product-expansion')
export class CommerceProductExpansionStageController {
  constructor(
    private readonly service: CommerceProductExpansionStageService,
  ) {}
