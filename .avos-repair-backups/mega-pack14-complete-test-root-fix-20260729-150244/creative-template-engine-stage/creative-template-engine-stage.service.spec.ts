...
describe('CreativeTemplateEngineStageService', () => {
  let service: CreativeTemplateEngineStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [CreativeTemplateEngineStageService] }).compile();
    service = module.get(CreativeTemplateEngineStageService);
  });
