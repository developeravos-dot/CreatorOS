...
describe('VisualStyleIntelligenceStageService', () => {
  let service: VisualStyleIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [VisualStyleIntelligenceStageService] }).compile();
    service = module.get(VisualStyleIntelligenceStageService);
  });
