...
@Controller('media/global-expansion/translation-localization')
export class TranslationLocalizationStageController {
  constructor(
    private readonly service: TranslationLocalizationStageService,
  ) {}
