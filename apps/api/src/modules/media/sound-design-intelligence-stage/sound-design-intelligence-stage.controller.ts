...
@Controller('media/creative-ecosystem/sound-design-intelligence')
export class SoundDesignIntelligenceStageController {
  constructor(private readonly service: SoundDesignIntelligenceStageService) {}
