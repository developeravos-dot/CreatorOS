...
@Controller('media/ip-empire/enforcement-dispute-resolution')
export class EnforcementDisputeResolutionStageController {
  constructor(
    private readonly service: EnforcementDisputeResolutionStageService,
  ) {}
