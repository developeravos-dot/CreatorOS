...
@Controller('media/ultra-ecosystem/music-intelligence')
export class MusicIntelligenceStageController {
  constructor(
    private readonly service: MusicIntelligenceStageService,
  ) {}
