...
describe('AudienceEconomicIntelligenceStageService', () => {
  let service: AudienceEconomicIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [AudienceEconomicIntelligenceStageService] }).compile();
    service = module.get<AudienceEconomicIntelligenceStageService>(AudienceEconomicIntelligenceStageService);
  });
