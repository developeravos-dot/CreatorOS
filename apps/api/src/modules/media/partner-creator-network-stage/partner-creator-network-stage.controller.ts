...
@Controller('media/global-expansion/partner-creator-network')
export class PartnerCreatorNetworkStageController {
  constructor(
    private readonly service: PartnerCreatorNetworkStageService,
  ) {}
