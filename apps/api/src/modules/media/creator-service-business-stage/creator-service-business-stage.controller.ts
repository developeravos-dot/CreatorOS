...
@Controller('media/business-revenue/creator-service-business')
export class CreatorServiceBusinessStageController {
  constructor(private readonly service: CreatorServiceBusinessStageService) {}
