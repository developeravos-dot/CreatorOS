...
@Controller('media/business-revenue/business-client-solutions')
export class BusinessClientSolutionsStageController {
  constructor(private readonly service: BusinessClientSolutionsStageService) {}
