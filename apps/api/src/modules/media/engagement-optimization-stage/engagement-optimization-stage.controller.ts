...
@Controller('media/ultra-ecosystem/engagement-optimization')
export class EngagementOptimizationStageController {
  constructor(
    private readonly service: EngagementOptimizationStageService,
  ) {}
