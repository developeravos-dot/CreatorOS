...
@Controller('media/release-performance-intelligence')
export class ReleasePerformanceIntelligenceController {
  constructor(
    private readonly service: ReleasePerformanceIntelligenceService,
  ) {}
