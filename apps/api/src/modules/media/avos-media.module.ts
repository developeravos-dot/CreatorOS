import { MediaCommandCenterModule } from './media-command-center-mega-pack/media-command-center.module';
import { OrganizationAutomationModule } from './organization-automation-mega-pack/organization-automation.module';
import { IntelligenceCoreModule } from './intelligence-core-mega-pack/intelligence-core.module';
import { IpBrandGrowthModule } from './ip-brand-growth-mega-pack/ip-brand-growth.module';
import { AudienceDistributionModule } from './audience-distribution-mega-pack/audience-distribution.module';
import { CreativeIntelligenceModule } from './creative-intelligence-mega-pack/creative-intelligence.module';
import { MediaCreativeEcosystemBrandModule } from './media-creative-ecosystem-brand-platform/media-creative-ecosystem-brand.module';
import { MediaCivilizationOperatingSystemModule } from './media-civilization-operating-system/media-civilization-operating-system.module';
import { MediaMetaIntelligenceNexusModule } from './media-meta-intelligence-nexus/media-meta-intelligence-nexus.module';
import { MediaIntelligenceCloudModule } from './media-intelligence-cloud/media-intelligence-cloud.module';
import { MediaAutonomousEnterprisePlatformModule } from './media-autonomous-enterprise-platform/media-autonomous-enterprise-platform.module';
import { MediaGlobalOperatingSystemModule } from './media-global-operating-system/media-global-operating-system.module';
import { MediaEnterpriseExpansionPlatformModule } from './media-enterprise-expansion-platform/media-enterprise-expansion-platform.module';
import { MediaGrowthOpportunityPlatformModule } from './media-growth-opportunity-platform/media-growth-opportunity-platform.module';
import { GlobalMediaIpPlatformModule } from './global-media-ip-platform/global-media-ip-platform.module';
import { CreativeBrandEcosystemModule } from './creative-brand-ecosystem/creative-brand-ecosystem.module';
import { MediaGalaxyModule } from './media-galaxy/media-galaxy.module';
import { AutonomousMediaOperationsModule } from './autonomous-media-operations/autonomous-media-operations.module';
...
@Module({
  imports: [
    MediaCommandCenterModule,
    OrganizationAutomationModule,
    IntelligenceCoreModule,
    IpBrandGrowthModule,
    AudienceDistributionModule,
    CreativeIntelligenceModule,
    MediaCreativeEcosystemBrandModule,MediaCivilizationOperatingSystemModule,
    MediaMetaIntelligenceNexusModule,
    MediaIntelligenceCloudModule,
    MediaAutonomousEnterprisePlatformModule,
    MediaGlobalOperatingSystemModule,
    MediaEnterpriseExpansionPlatformModule,
    MediaGrowthOpportunityPlatformModule,
    GlobalMediaIpPlatformModule,
    CreativeBrandEcosystemModule,
    MediaGalaxyModule,AutonomousMediaOperationsModule,
