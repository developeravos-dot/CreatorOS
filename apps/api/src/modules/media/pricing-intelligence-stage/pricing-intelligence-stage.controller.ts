...
@Controller('media/business-revenue/pricing-intelligence')
export class PricingIntelligenceStageController {
  constructor(private readonly service: PricingIntelligenceStageService) {}
