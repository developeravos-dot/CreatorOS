...
describe('MarketplaceIntelligenceStageService', () => {
  let service: MarketplaceIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [MarketplaceIntelligenceStageService] }).compile();
    service = module.get<MarketplaceIntelligenceStageService>(MarketplaceIntelligenceStageService);
  });
