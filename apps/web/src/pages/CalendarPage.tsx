    ...
    <div className="calendar-v2">
      <header className="calendar-v2-header">
        <div>
          ...
          <p>
            Plan, inspect and organize
            scheduled CreatorOS content
            across projects and
            platforms.
          </p>
        </div>
      ...
      <section className="calendar-v2-query-status">
        <div>
          <strong>
            {loading
              ? "Loading calendar..."
      ...
      {error ? (
        <div
          className="calendar-v2-query-error"
          role="alert"
        >
          {error}
        </div>
