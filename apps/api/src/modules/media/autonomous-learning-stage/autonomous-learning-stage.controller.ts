...
@Controller('media/ultra-ecosystem/autonomous-learning')
export class AutonomousLearningStageController {
  constructor(
    private readonly service: AutonomousLearningStageService,
  ) {}
