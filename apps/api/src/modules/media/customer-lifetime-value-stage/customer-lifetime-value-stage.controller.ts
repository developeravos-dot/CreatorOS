...
@Controller('media/business-revenue/customer-lifetime-value')
export class CustomerLifetimeValueStageController {
  constructor(private readonly service: CustomerLifetimeValueStageService) {}
