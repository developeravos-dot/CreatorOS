...
@Controller('media/privacy-copyright-governance')
export class PrivacyCopyrightGovernanceEngineController {
  constructor(
    private readonly service: PrivacyCopyrightGovernanceEngineService,
  ) {}
