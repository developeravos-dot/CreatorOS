...
@Controller('media/ip-empire/infringement-monitoring')
export class InfringementMonitoringStageController {
  constructor(
    private readonly service: InfringementMonitoringStageService,
  ) {}
