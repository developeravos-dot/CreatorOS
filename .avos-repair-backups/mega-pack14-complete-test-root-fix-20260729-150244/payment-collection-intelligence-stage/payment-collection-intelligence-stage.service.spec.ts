...
describe('PaymentCollectionIntelligenceStageService', () => {
  let service: PaymentCollectionIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [PaymentCollectionIntelligenceStageService] }).compile();
    service = module.get<PaymentCollectionIntelligenceStageService>(PaymentCollectionIntelligenceStageService);
  });
