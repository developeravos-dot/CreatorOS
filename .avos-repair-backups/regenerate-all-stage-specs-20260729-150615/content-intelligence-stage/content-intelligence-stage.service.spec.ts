...
describe('ContentIntelligenceStageService', () => {
  let service: ContentIntelligenceStageService;
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [ContentIntelligenceStageService] }).compile();
    service = module.get(ContentIntelligenceStageService);
  });
