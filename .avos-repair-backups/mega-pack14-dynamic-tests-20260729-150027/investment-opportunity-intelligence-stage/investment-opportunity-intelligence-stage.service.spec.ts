...
describe('InvestmentOpportunityIntelligenceStageService', () => {
  let service: InvestmentOpportunityIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [InvestmentOpportunityIntelligenceStageService] }).compile();
    service = module.get<InvestmentOpportunityIntelligenceStageService>(InvestmentOpportunityIntelligenceStageService);
  });
