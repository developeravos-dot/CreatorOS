...
@Controller('media/global-expansion/licensing-franchise-expansion')
export class LicensingFranchiseExpansionStageController {
  constructor(
    private readonly service: LicensingFranchiseExpansionStageService,
  ) {}
