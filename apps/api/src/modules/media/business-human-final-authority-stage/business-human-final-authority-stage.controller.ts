...
@Controller('media/business-revenue/human-final-authority')
export class BusinessHumanFinalAuthorityStageController {
  constructor(private readonly service: BusinessHumanFinalAuthorityStageService) {}
