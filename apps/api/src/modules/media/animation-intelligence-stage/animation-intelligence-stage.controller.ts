...
@Controller('media/ultra-ecosystem/animation-intelligence')
export class AnimationIntelligenceStageController {
  constructor(
    private readonly service: AnimationIntelligenceStageService,
  ) {}
