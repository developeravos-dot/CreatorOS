...
@Controller('media/ultra-ecosystem/community-intelligence')
export class CommunityIntelligenceStageController {
  constructor(
    private readonly service: CommunityIntelligenceStageService,
  ) {}
