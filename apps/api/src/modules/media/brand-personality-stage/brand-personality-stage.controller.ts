...
@Controller('media/creative-ecosystem/brand-personality')
export class BrandPersonalityStageController {
  constructor(private readonly service: BrandPersonalityStageService) {}
