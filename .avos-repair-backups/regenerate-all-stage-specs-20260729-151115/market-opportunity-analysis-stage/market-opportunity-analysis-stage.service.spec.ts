...
describe('MarketOpportunityAnalysisStageService', () => {
  let service: MarketOpportunityAnalysisStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [MarketOpportunityAnalysisStageService],
    }).compile();

    service = module.get<MarketOpportunityAnalysisStageService>(MarketOpportunityAnalysisStageService);
  });
