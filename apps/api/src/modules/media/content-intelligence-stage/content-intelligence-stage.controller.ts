...
@Controller('media/creative-ecosystem/content-intelligence')
export class ContentIntelligenceStageController {
  constructor(private readonly service: ContentIntelligenceStageService) {}
