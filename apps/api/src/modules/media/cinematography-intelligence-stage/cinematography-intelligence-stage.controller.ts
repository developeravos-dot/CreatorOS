...
@Controller('media/ultra-ecosystem/cinematography-intelligence')
export class CinematographyIntelligenceStageController {
  constructor(
    private readonly service: CinematographyIntelligenceStageService,
  ) {}
