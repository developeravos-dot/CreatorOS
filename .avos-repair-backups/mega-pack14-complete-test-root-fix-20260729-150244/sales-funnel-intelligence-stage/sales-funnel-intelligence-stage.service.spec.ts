...
describe('SalesFunnelIntelligenceStageService', () => {
  let service: SalesFunnelIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [SalesFunnelIntelligenceStageService] }).compile();
    service = module.get<SalesFunnelIntelligenceStageService>(SalesFunnelIntelligenceStageService);
  });
