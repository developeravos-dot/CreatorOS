...
@Controller('media/business-revenue/business-model-intelligence')
export class BusinessModelIntelligenceStageController {
  constructor(private readonly service: BusinessModelIntelligenceStageService) {}
