...
@Controller('media/ultra-ecosystem/publishing-orchestration')
export class PublishingOrchestrationStageController {
  constructor(
    private readonly service: PublishingOrchestrationStageService,
  ) {}
