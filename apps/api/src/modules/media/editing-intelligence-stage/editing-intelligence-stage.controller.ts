...
@Controller('media/ultra-ecosystem/editing-intelligence')
export class EditingIntelligenceStageController {
  constructor(
    private readonly service: EditingIntelligenceStageService,
  ) {}
