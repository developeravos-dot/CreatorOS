...
describe('PricingIntelligenceStageService', () => {
  let service: PricingIntelligenceStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [PricingIntelligenceStageService] }).compile();
    service = module.get<PricingIntelligenceStageService>(PricingIntelligenceStageService);
  });
