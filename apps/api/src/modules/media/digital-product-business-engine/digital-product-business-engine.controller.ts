...
@Controller('media/digital-product-business')
export class DigitalProductBusinessEngineController {
  constructor(
    private readonly service: DigitalProductBusinessEngineService,
  ) {}
