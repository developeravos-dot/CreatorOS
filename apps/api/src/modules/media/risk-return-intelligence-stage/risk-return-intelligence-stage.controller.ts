...
@Controller('media/business-revenue/risk-return-intelligence')
export class RiskReturnIntelligenceStageController {
  constructor(private readonly service: RiskReturnIntelligenceStageService) {}
