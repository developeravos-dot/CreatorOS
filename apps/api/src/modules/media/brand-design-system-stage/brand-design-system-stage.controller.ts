...
@Controller('media/creative-ecosystem/brand-design-system')
export class BrandDesignSystemStageController {
  constructor(private readonly service: BrandDesignSystemStageService) {}
