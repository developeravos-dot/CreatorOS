...
@Controller('media/ultra-ecosystem/storyboard-intelligence')
export class StoryboardIntelligenceStageController {
  constructor(
    private readonly service: StoryboardIntelligenceStageService,
  ) {}
