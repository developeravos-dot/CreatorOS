...
@Controller('media/ip-empire/protectability-analysis')
export class ProtectabilityAnalysisStageController {
  constructor(
    private readonly service: ProtectabilityAnalysisStageService,
  ) {}
