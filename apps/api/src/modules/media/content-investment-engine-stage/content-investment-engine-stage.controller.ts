...
@Controller('media/business-revenue/content-investment-engine')
export class ContentInvestmentEngineStageController {
  constructor(private readonly service: ContentInvestmentEngineStageService) {}
