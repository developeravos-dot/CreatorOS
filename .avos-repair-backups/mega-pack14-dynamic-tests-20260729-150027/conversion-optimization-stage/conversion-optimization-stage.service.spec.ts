...
describe('ConversionOptimizationStageService', () => {
  let service: ConversionOptimizationStageService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({ providers: [ConversionOptimizationStageService] }).compile();
    service = module.get<ConversionOptimizationStageService>(ConversionOptimizationStageService);
  });
